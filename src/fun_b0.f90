subroutine background_b0
    ...
    i_coil=1; I_th(i_coil)=750*1200*0.6;!A
    i_coil=2; I_th(i_coil)=750*1200*0.24;!A

    !(1:4)=(r1,r2,z1,z2)
    ! coil 1
    i_coil=1;
    posi_coils(1,i_coil)=0.07;
    posi_coils(2,i_coil)=posi_coils(1,i_coil)+0.05;
